class ZabbixAgentd < Formula
    ...
    url "https://mac-repo.scivisum.co.uk/sources/zabbix_agentd/zabbix-3.4.7.tar.gz"
    ...
    def install
        ...
        system *%W(./configure --enable-agent --prefix=#{prefix} --with-iconv=#{iconv_prefix} --with-libpcre=#{pcre_prefix})
        system "make"
