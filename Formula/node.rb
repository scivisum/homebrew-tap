class Node < Formula
  ...
  url "https://mac-repo.scivisum.co.uk/sources/node/node-v10.8.0.tar.gz"
  ...
  bottle do
    ...
    rebuild 2
    sha256 cellar: :any_skip_relocation, high_sierra: "2ca650be72a2f02efa8b76f0a8ce067ead9d93caa9cc5b2a729a22c7f03dd412"
  end

  # We track major/minor from upstream Node releases.
  # We will accept *important* npm patch releases when necessary.
  resource "npm" do
    url "https://mac-repo.scivisum.co.uk/sources/node/npm-6.2.0.tgz"
